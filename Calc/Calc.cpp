...
BEGIN_MESSAGE_MAP(CCalcApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CCalcApp::OnAppAbout)
...
BOOL CCalcApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_CalcTYPE,
		RUNTIME_CLASS(CCalcDoc),
